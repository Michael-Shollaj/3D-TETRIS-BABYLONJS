...
var Menu = /** @class */ (function () {
    function Menu() {
        ...
        this._font = "Open Sans";
        this._start = new BABYLON.GUI.TextBlock("start");
        this._start.text = "K L I K O   K U   T E   D U A SH    Q E   T E   F I LL O SH";
        this._start.color = "cyan";
        ...
        this._authors.text = "N  G  A     M  I  C  H  A  E  L       S  H  O  L  L  A J";
        this._authors.color = "red";
